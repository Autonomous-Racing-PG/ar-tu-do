...
\hline
\rowcolor{\tableheadbgcolor}\multirow{2}{\linewidth}{{\bf Argument }}&\multirow{2}{\linewidth}{{\bf Description }}&\multicolumn{4}{p{(\linewidth-\tabcolsep*6-\arrayrulewidth*3)*4/6}|}{\cellcolor{\tableheadbgcolor}{\bf Supported by {\ttfamily launch/$<$file$>$.launch}  }}\\\cline{3-6}
\endfirsthead
\hline
\endfoot
\hline
\rowcolor{\tableheadbgcolor}&&\multirow{2}{\linewidth}{{\bf Argument }}&\multirow{2}{\linewidth}{{\bf Description }}&\multicolumn{4}{p{(\linewidth-\tabcolsep*6-\arrayrulewidth*3)*4/6}|}{\cellcolor{\tableheadbgcolor}{\bf Supported by {\ttfamily launch/$<$file$>$.launch}  }}\\\cline{1-2}\cline{5-6}
\endhead
car &gazebo &&&navigation\+\_\+stack &qlearning, evolutionary  \\\cline{1-6}
