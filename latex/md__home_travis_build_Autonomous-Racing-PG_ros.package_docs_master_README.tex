...
\begin{DoxyCode}
1 # RangeLibc
2 sudo pip uninstall pip && sudo apt install python-pip
3 sudo pip install cython
4 git clone http://github.com/kctess5/range\_libc
5 cd range\_libc/pywrapper
6 # Either:
7 ./compile.sh            # on VM
8 # Or:
9 ./compile\_with\_cuda.sh  # on car - compiles GPU ray casting methods
\end{DoxyCode}
