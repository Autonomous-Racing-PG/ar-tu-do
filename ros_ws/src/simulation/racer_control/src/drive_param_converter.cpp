...
DriveParamConverter::DriveParamConverter()
{
    this->m_drive_parameters_subscriber =
        this->m_node_handle.subscribe< drive_msgs::drive_param >(
            "/set/drive_param", 1,
            &DriveParamConverter::convertDriveParametersCallback, this);
    this->m_left_rear_wheel_velocity_publisher =
        this->m_node_handle.advertise< std_msgs::Float64 >(
            "/racer/left_wheel_back_velocity_controller/command", 1);
    this->m_right_rear_wheel_velocity_publisher =
        this->m_node_handle.advertise< std_msgs::Float64 >(
            "/racer/right_wheel_back_velocity_controller/command", 1);
    this->m_left_front_wheel_velocity_publisher =
        this->m_node_handle.advertise< std_msgs::Float64 >(
            "/racer/left_wheel_front_velocity_controller/command", 1);
    this->m_right_front_wheel_velocity_publisher =
        this->m_node_handle.advertise< std_msgs::Float64 >(
            "/racer/right_wheel_front_velocity_controller/command", 1);

    this->m_left_steering_position_publisher =
        this->m_node_handle.advertise< std_msgs::Float64 >(
            "/racer/left_steering_hinge_position_controller/command", 1);
    this->m_right_steering_position_publisher =
        this->m_node_handle.advertise< std_msgs::Float64 >(
            "/racer/right_steering_hinge_position_controller/command", 1);
}
